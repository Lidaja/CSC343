    ...
    public static void main(String args[]) throws IOException
        {
            ...
            try
            {
                ...
                url = "jdbc:postgresql://localhost:5432/csc343h-jacks233";
                conn = DriverManager.getConnection(url, "jacks233", "");
		...
		String age = ar.readLine();
		queryString = "select avg(guess) as ag from guesses where age >= ?";
		PreparedStatement as = conn.prepareStatement(queryString);
		as.setInt(1, Integer.parseInt(age));
		rs = as.executeQuery();
		rs.next();
		int average =  rs.getInt("ag");
		System.out.println("The average guess of kids older than " + age + " is " +average);
